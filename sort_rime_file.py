...
shutil.copyfile("./allfiles/easy_en_b.dict.yaml", "./sort_rime/洋蔥mixin版注音/easy_en_comment.dict.yaml")
shutil.copyfile("./allfiles/easy_en_b.schema.yaml", "./sort_rime/洋蔥mixin版注音/easy_en_comment.schema.yaml")
...
shutil.copyfile("./allfiles/easy_en_b.dict.yaml", "./sort_rime/洋蔥plus版注音/easy_en_comment.dict.yaml")
shutil.copyfile("./allfiles/easy_en_b.schema.yaml", "./sort_rime/洋蔥plus版注音/easy_en_comment.schema.yaml")
