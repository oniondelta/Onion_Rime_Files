...
shutil.copyfile("./allfiles/bo_mixin1_old.schema.yaml", "./sort_rime/注音洋蔥mixin版/bo_mixin1_old.schema.yaml")
...
shutil.copyfile("./allfiles/bo_mixin3_old.schema.yaml", "./sort_rime/注音洋蔥mixin版/bo_mixin3_old.schema.yaml")
