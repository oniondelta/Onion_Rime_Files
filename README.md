...
- Linux、Win、Mac 皆需注意核心 librime 版本問題：
  ...
  > Win 建議使用 [weasel 0.17.0](https://github.com/rime/weasel/releases/tag/0.17.0) 版本。[weasel 0.17.3](https://github.com/rime/squirrel/releases) 以上的正式版和 Nightly Build 測試，遇過方案部屬不起來無法使用之問題！
