...
- 比對詞彙單個字的發音，修正為方案字典中單字有的發音，符合一般輸入法習慣，故詞彙發音可能會與詞典中的發音（例：[萌典](https://www.moedict.tw/)和[教育部重編國語辭典](http://dict.revised.moe.edu.tw/cbdic/)）不同。（詞句中變調等之發音不收錄，原變調或錯誤之發音詞彙轉到 phrases.chtpp.dict.yaml 該檔；如詞彙中單個字的發音在以下比對之字典有的，但方案字典沒有，則補上）
- 比對之字典：
